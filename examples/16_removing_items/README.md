...
As we saw in [Tutorial 13](https://confarg.github.io/confarg/examples/13_dictionaries/), referring to a particular elements by its index can be fragile, and dictionaries may be a helpful alternative. Hopefully, removing dictionaries items is possible too.
